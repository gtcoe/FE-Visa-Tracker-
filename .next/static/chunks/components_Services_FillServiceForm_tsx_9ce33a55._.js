...
var __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$application$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/api/application.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/constants/dropdown/geographical.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/constants/formConstants.ts [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$appConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/constants/appConstants.ts [app-client] (ecmascript)");
;
...
const FillServiceForm = ({ handleTabChange, formMode, setFormMode, visaRequests, setVisaRequests, handleAddMore })=>{
    ...
    const isPrefill = "object" !== 'undefined' && new URL(window.location.href).searchParams.get('prefill') === 'true';
    // Try to get application ID from localStorage or URL and also determine the form mode
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FillServiceForm.useEffect": ()=>{
            console.log('FillServiceForm - initialization useEffect');
            // Set form mode to EDIT if we're in prefill mode
            if (isPrefill) {
                setFormMode(__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FORM_MODE"].EDIT);
                console.log('Setting form mode to EDIT due to prefill parameter');
            }
            // Check localStorage for application ID
            const storedAppId = localStorage.getItem(__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STORAGE_KEY"].APPLICATION_ID);
            ...
            const mode = localStorage.getItem(__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STORAGE_KEY"].FORM_MODE);
            console.log('Found formMode in localStorage:', mode);
            if (mode === __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FORM_MODE"].VIEW || mode === __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FORM_MODE"].EDIT || mode === __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FORM_MODE"].ADD_SUB_REQUEST) {
                setFormMode(mode);
            ...
            if (mode === __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FORM_MODE"].ADD_SUB_REQUEST) {
                console.log('Adding new visa request for add-sub-request mode');
                setVisaRequests({
                    "FillServiceForm.useEffect": (prev)=>[
                            ...prev,
                            {
                                visaCountry: __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VISA_COUNTRY_LABELS"][__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["COUNTRY"].NETHERLANDS],
                                visaCategory: __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VISA_CATEGORY_LABELS"][__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VISA_CATEGORY"].BUSINESS],
                                nationality: __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NATIONALITY_LABELS"][__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NATIONALITY"].INDIAN],
                                state: __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STATE_LABELS"][__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STATE"].DELHI],
                                entryType: __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ENTRY_TYPE_LABELS"][__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ENTRY_TYPE"].NORMAL],
                                remark: ''
                            }
                        ]
                }["FillServiceForm.useEffect"]);
            ...
            const loadApplicationData = {
                "FillServiceForm.useEffect.loadApplicationData": ()=>{
                    try {
                        // Check for application data in localStorage
                        const appDataStr = localStorage.getItem(__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STORAGE_KEY"].APPLICATION_INFO);
                        if (appDataStr) {
                            ...
                            localStorage.setItem(__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STORAGE_KEY"].SERVICE_REFERENCE_NUMBER, referenceNumber || '');
                            ...
                            if (parsedData.personal_info) {
                                setPersonalInfo({
                                    ...
                                    processingBranch: parsedData.personal_info.processing_branch ? __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PROCESSING_BRANCH_LABELS"][parsedData.personal_info.processing_branch] || __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PROCESSING_BRANCH_LABELS"][__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PROCESSING_BRANCH"].VISAISTIC_DELHI] : __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PROCESSING_BRANCH_LABELS"][__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PROCESSING_BRANCH"].VISAISTIC_DELHI]
                                });
                            }
                            ...
                            if (isPrefill && window.opener) {
                                ...
                                if (parsedData.visa_requests && parsedData.visa_requests.length > 0) {
                                    ...
                                    for (const sourceRequest of parsedData.visa_requests){
                                        ...
                                        const newRequest = {
                                            visaCountry: sourceRequest.visa_country ? __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VISA_COUNTRY_LABELS"][sourceRequest.visa_country] || __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VISA_COUNTRY_LABELS"][__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["COUNTRY"].NETHERLANDS] : __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VISA_COUNTRY_LABELS"][__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["COUNTRY"].NETHERLANDS],
                                            visaCategory: sourceRequest.visa_category ? __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VISA_CATEGORY_LABELS"][sourceRequest.visa_category] || __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VISA_CATEGORY_LABELS"][__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VISA_CATEGORY"].BUSINESS] : __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VISA_CATEGORY_LABELS"][__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VISA_CATEGORY"].BUSINESS],
                                            nationality: sourceRequest.nationality ? __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NATIONALITY_LABELS"][sourceRequest.nationality] || __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NATIONALITY_LABELS"][__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NATIONALITY"].INDIAN] : __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NATIONALITY_LABELS"][__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NATIONALITY"].INDIAN],
                                            state: sourceRequest.state ? __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STATE_LABELS"][sourceRequest.state] || __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STATE_LABELS"][__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STATE"].DELHI] : __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STATE_LABELS"][__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STATE"].DELHI],
                                            entryType: sourceRequest.entry_type ? __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ENTRY_TYPE_LABELS"][sourceRequest.entry_type] || __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ENTRY_TYPE_LABELS"][__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ENTRY_TYPE"].NORMAL] : __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ENTRY_TYPE_LABELS"][__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ENTRY_TYPE"].NORMAL],
                                            remark: ''
                                        };
                                ...
                                if (parsedData.visa_requests && parsedData.visa_requests.length > 0) {
                                    ...
                                    try {
                                        ...
                                        parsedData.visa_requests.forEach({
                                            "FillServiceForm.useEffect.loadApplicationData": (sourceRequest, index)=>{
                            ...
                            if (parsedData.address_info) {
                                setAddressInfo({
                                    ...
                                    country: findLabelByValue(parsedData.address_info.country, __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["COUNTRY_LABELS"]) || '',
                                    state: findLabelByValue(parsedData.address_info.state, __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STATE_LABELS"]) || '',
    ...
    const [referNumber, setReferenceNumber] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    const countryMap = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "FillServiceForm.useMemo[countryMap]": ()=>Object.entries(__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["COUNTRY_LABELS"]).reduce({
                "FillServiceForm.useMemo[countryMap]": (acc, [numValue, label])=>{
                    acc[label] = parseInt(numValue, 10);
                    return acc;
                }
            }["FillServiceForm.useMemo[countryMap]"], {})
    }["FillServiceForm.useMemo[countryMap]"], []);
    const stateMap = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "FillServiceForm.useMemo[stateMap]": ()=>Object.entries(__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STATE_LABELS"]).reduce({
                "FillServiceForm.useMemo[stateMap]": (acc, [numValue, label])=>{
                    acc[label] = parseInt(numValue, 10);
                    return acc;
                }
            }["FillServiceForm.useMemo[stateMap]"], {})
    }["FillServiceForm.useMemo[stateMap]"], []);
    const processingBranchMap = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "FillServiceForm.useMemo[processingBranchMap]": ()=>({
                [__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PROCESSING_BRANCH_LABELS"][__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PROCESSING_BRANCH"].VISAISTIC_DELHI]]: __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PROCESSING_BRANCH"].VISAISTIC_DELHI
            })
    }["FillServiceForm.useMemo[processingBranchMap]"], []);
    const visaCountryMap = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "FillServiceForm.useMemo[visaCountryMap]": ()=>({
                [__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VISA_COUNTRY_LABELS"][__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["COUNTRY"].NETHERLANDS] || ""]: __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["COUNTRY"].NETHERLANDS
            })
    }["FillServiceForm.useMemo[visaCountryMap]"], []);
    const visaCategoryMap = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "FillServiceForm.useMemo[visaCategoryMap]": ()=>({
                [__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VISA_CATEGORY_LABELS"][__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VISA_CATEGORY"].BUSINESS]]: __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VISA_CATEGORY"].BUSINESS
            })
    }["FillServiceForm.useMemo[visaCategoryMap]"], []);
    const nationalityMap = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "FillServiceForm.useMemo[nationalityMap]": ()=>({
                [__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NATIONALITY_LABELS"][__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NATIONALITY"].INDIAN]]: __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NATIONALITY"].INDIAN
            })
    }["FillServiceForm.useMemo[nationalityMap]"], []);
    const entryTypeMap = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "FillServiceForm.useMemo[entryTypeMap]": ()=>({
                [__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ENTRY_TYPE_LABELS"][__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ENTRY_TYPE"].NORMAL]]: __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ENTRY_TYPE"].NORMAL
            })
    }["FillServiceForm.useMemo[entryTypeMap]"], []);
    ...
    const handleSubmit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "FillServiceForm.useCallback[handleSubmit]": async (e)=>{
            e.preventDefault();
            // If in view mode, just navigate to the summary page without API call
            if (formMode === __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FORM_MODE"].VIEW) {
                handleTabChange(__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TAB_NAME"].SUMMARY);
                return;
            }
            ...
            try {
                ...
                const payload = {
                    ...
                    visa_requests: visaRequests.map({
                        "FillServiceForm.useCallback[handleSubmit]": (request)=>({
                    ...
                    reference_number: localStorage.getItem(__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STORAGE_KEY"].SERVICE_REFERENCE_NUMBER) || '',
                ...
                // Submit to API
                const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$application$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addApplicationStep3"])(payload);
                if (response.status) {
                    ...
                    if (response.data && response.data.application_requests) {
                        response.data.application_requests.status = __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$appConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["APPLICATION_STATUS"].STEP3_DONE;
                        localStorage.setItem(__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STORAGE_KEY"].APPLICATION_INFO, JSON.stringify(response.data.application_requests));
                    }
                    // Navigate to next step or show success message
                    handleTabChange(__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TAB_NAME"].SUMMARY);
                } else {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$common$2f$Toast$2f$index$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ToastNotifyError"])(response.message || 'Failed to submit application. Please try again.');
                }
            } catch (error) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$common$2f$Toast$2f$index$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ToastNotifyError"])(error.message || 'An error occurred while submitting the form. Please try again.');
    ...
    const handleUpdateApplicant = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "FillServiceForm.useCallback[handleUpdateApplicant]": async ()=>{
            try {
                await handleSubmit({
                    preventDefault: {
    ...
    const handleUpdateAndContinue = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "FillServiceForm.useCallback[handleUpdateAndContinue]": async ()=>{
            try {
                await handleSubmit({
                    preventDefault: {
    ...
    const processingBranchOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "FillServiceForm.useMemo[processingBranchOptions]": ()=>[
                {
                    value: __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PROCESSING_BRANCH_LABELS"][__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PROCESSING_BRANCH"].VISAISTIC_DELHI],
    ...
    const countryOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "FillServiceForm.useMemo[countryOptions]": ()=>[
                {
                    value: '',
                    label: 'Select'
                },
                ...Object.entries(__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["COUNTRY_LABELS"]).map({
                    "FillServiceForm.useMemo[countryOptions]": ([value, label])=>({
                            value: label,
                            label: label
                        })
                }["FillServiceForm.useMemo[countryOptions]"])
    ...
    const indianStateOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "FillServiceForm.useMemo[indianStateOptions]": ()=>[
                {
                    value: '',
                    label: 'Select'
                },
                ...Object.entries(__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STATE_LABELS"]).map({
                    "FillServiceForm.useMemo[indianStateOptions]": ([value, label])=>({
                            value: label,
                            label: label
                        })
                }["FillServiceForm.useMemo[indianStateOptions]"])
    ...
    const handleRemoveVisaRequest = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "FillServiceForm.useCallback[handleRemoveVisaRequest]": (indexToRemove)=>{
            setVisaRequests({
                "FillServiceForm.useCallback[handleRemoveVisaRequest]": (prev)=>prev.filter({
                        "FillServiceForm.useCallback[handleRemoveVisaRequest]": (_, index)=>index !== indexToRemove
                    }["FillServiceForm.useCallback[handleRemoveVisaRequest]"])
            }["FillServiceForm.useCallback[handleRemoveVisaRequest]"]);
        }
    }["FillServiceForm.useCallback[handleRemoveVisaRequest]"], []);
    // Update the function to ensure it works correctly
    const handleAddNewVisaRequest = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "FillServiceForm.useCallback[handleAddNewVisaRequest]": ()=>{
            ...
            if (typeof handleAddMore === 'function') {
                ...
                }["FillServiceForm.useCallback[handleAddNewVisaRequest]"], 500);
            } else {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: `Reference No: ${localStorage.getItem(__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STORAGE_KEY"].SERVICE_REFERENCE_NUMBER) ? localStorage.getItem(__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STORAGE_KEY"].SERVICE_REFERENCE_NUMBER) : referNumber}`
                        }, void 0, false, {
                            fileName: "[project]/components/Services/FillServiceForm.tsx",
                            lineNumber: 874,
                            columnNumber: 11
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                            ...
                                            className: `w-full px-3 py-2.5 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#0B498B] text-[#6A6A6A] ${formMode === __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FORM_MODE"].VIEW ? 'bg-gray-100' : 'bg-white'}`,
                                            readOnly: formMode === __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FORM_MODE"].VIEW
                                        }, void 0, false, {
                                            fileName: "[project]/components/Services/FillServiceForm.tsx",
                                            lineNumber: 883,
                                            columnNumber: 15
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                            ...
                                            onChange: handlePersonalInfoChange,
                                            className: `w-full px-3 py-2.5 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#0B498B] text-[#6A6A6A] appearance-none ${formMode === __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FORM_MODE"].VIEW ? 'bg-gray-100' : 'bg-white'}`,
                                            disabled: formMode === __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FORM_MODE"].VIEW,
                                            children: processingBranchOptions.map((option)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                    value: option.value,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: `flex items-center space-x-2 ${formMode === __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FORM_MODE"].VIEW ? 'opacity-70' : ''}`,
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                type: "radio",
                                                id: "tentative",
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                visaRequests.length > 1 && formMode !== __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FORM_MODE"].VIEW && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    type: "button",
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                    ...
                                                    className: `w-full px-3 py-2.5 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#0B498B] text-[#6A6A6A] appearance-none ${formMode === __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FORM_MODE"].VIEW ? 'bg-gray-100' : 'bg-white'}`,
                                                    disabled: formMode === __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FORM_MODE"].VIEW,
                                                    children: Object.entries(__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VISA_COUNTRY_LABELS"]).map(([value, label])=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                            value: value,
                                                            children: label
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                    ...
                                                    className: `w-full px-3 py-2.5 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#0B498B] text-[#6A6A6A] appearance-none ${formMode === __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FORM_MODE"].VIEW ? 'bg-gray-100' : 'bg-white'}`,
                                                    disabled: formMode === __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FORM_MODE"].VIEW,
                                                    children: Object.entries(__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VISA_CATEGORY_LABELS"]).map(([value, label])=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                            value: value,
                                                            children: label
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                    ...
                                                    className: `w-full px-3 py-2.5 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#0B498B] text-[#6A6A6A] appearance-none ${formMode === __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FORM_MODE"].VIEW ? 'bg-gray-100' : 'bg-white'}`,
                                                    disabled: formMode === __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FORM_MODE"].VIEW,
                                                    children: Object.entries(__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NATIONALITY_LABELS"]).map(([value, label])=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                            value: value,
                                                            children: label
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                    ...
                                                    className: `w-full px-3 py-2.5 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#0B498B] text-[#6A6A6A] appearance-none ${formMode === __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FORM_MODE"].VIEW ? 'bg-gray-100' : 'bg-white'}`,
                                                    disabled: formMode === __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FORM_MODE"].VIEW,
                                                    children: Object.entries(__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["STATE_LABELS"]).map(([value, label])=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                            value: value,
                                                            children: label
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                    ...
                                                    className: `w-full px-3 py-2.5 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#0B498B] text-[#6A6A6A] appearance-none ${formMode === __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FORM_MODE"].VIEW ? 'bg-gray-100' : 'bg-white'}`,
                                                    disabled: formMode === __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FORM_MODE"].VIEW,
                                                    children: Object.entries(__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$dropdown$2f$geographical$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ENTRY_TYPE_LABELS"]).map(([value, label])=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                            value: value,
                                                            children: label
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                ...
                                                className: `w-full px-3 py-2.5 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#0B498B] text-[#6A6A6A] appearance-none ${formMode === __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FORM_MODE"].VIEW ? 'bg-gray-100' : 'bg-white'}`,
                                                disabled: formMode === __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FORM_MODE"].VIEW,
                                                children: indianStateOptions.map((option)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                        value: option.value,
                                                        children: option.label
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: formMode !== __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FORM_MODE"].VIEW && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    type: "button",
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                    ...
                                    className: `w-full max-w-md px-3 py-2.5 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#0B498B] text-[#6A6A6A] ${formMode === __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FORM_MODE"].VIEW ? 'bg-gray-100' : 'bg-white'}`,
                                    readOnly: formMode === __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FORM_MODE"].VIEW
                                }, void 0, false, {
                                    fileName: "[project]/components/Services/FillServiceForm.tsx",
                                    lineNumber: 1457,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        disabled: formMode !== __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FORM_MODE"].VIEW && !isFormValid || isSubmitting,
                        children: isSubmitting ? 'Submitting...' : formMode === __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$formConstants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FORM_MODE"].VIEW ? 'Next' : 'Update & Continue'
                    }, void 0, false, {
                        fileName: "[project]/components/Services/FillServiceForm.tsx",
                        lineNumber: 1481,
                        columnNumber: 9
...
_s1(FillServiceForm, "yVBgki7ZsyIfnQ6CAiaaZvbhuyo=", false, function() {
    return [
